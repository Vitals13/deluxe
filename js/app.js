 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider-solution__slider")) new core(".slider-solution__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                loop: true,
                navigation: {
                    prevEl: ".slider-solution__button_prev",
                    nextEl: ".slider-solution__button_next"
                }
            });
            if (document.querySelector(".guarantee-page__slider")) new core(".guarantee-page__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                loop: true,
                navigation: {
                    prevEl: ".control-guarantee__button_prev",
                    nextEl: ".control-guarantee__button_next"
                }
            });
        }
